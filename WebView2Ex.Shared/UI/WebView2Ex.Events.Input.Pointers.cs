...
using MouseEvKind = WV2::Microsoft.Web.WebView2.Core.CoreWebView2MouseEventKind;
using PointerEvKind = WV2::Microsoft.Web.WebView2.Core.CoreWebView2PointerEventKind;
using WV2Point = System.Drawing.Point;
...
using WV2Point = Windows.Foundation.Point;
...
partial class WebView2Ex
{
    ...
    void OnXamlMouseMessage(MouseEvKind message, PointerRoutedEventArgs args)
    {
        ...
        else
        {
            ...
            WV2Point coords_win32 = new((short)LoWord(l_param), (short)HiWord(l_param));

            WV2Point coords = coords_win32;
    ...
    void FillPointerTouchInfo(PointerPoint inputPt, CoreWebView2PointerInfo outputPt)
    {
        ...
        WV2Rect outputPt_touchContact = new((int)leftVal, (int)topVal, (int)width, (int)height);
...
#elif WinUI3
        double widthRaw = width;
        double heightRaw = height;
        double leftValRaw = leftVal;
        double topValRaw = topVal;
#endif

        WV2Rect outputPt_touchContactRaw = new((int)leftValRaw, (int)topValRaw, (int)widthRaw, (int)heightRaw);
    ...
    unsafe void FillPointerInfo(PointerPoint inputPt, CoreWebView2PointerInfo outputPt, PointerRoutedEventArgs args)
    {
        ...
        WV2Point outputPt_pointerPixelLocation = new((int)(rasterizationScale * inputPt.Position.X), (int)(rasterizationScale * inputPt.Position.Y));
...
#elif WinUI3
        WV2Point outputPt_pointerRawPixelLocation = outputPt_pointerPixelLocation;
#endif
...
#elif WinUI3
    private void CoreWebView2CursorChanged(object? sender, object args)
#endif
    {
    ...
    {
        var CompositionController = this.CompositionController;
        if (CompositionController is not null && isPointerOver)
        {
#if WINDOWS_UWP
            CoreWindow.GetForCurrentThread().PointerCursor = CompositionController.Cursor;
#elif WinUI3 && !NonWinRTWebView2
